        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeslachtSelect = table.Column<int>(type: "int", nullable: false),
                    Straat = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    Huisnummer = table.Column<int>(type: "int", nullable: true),
                    Postcode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Gemeente = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
